    ...
    try {
        ...
        const services = {
            'automacao-whatsapp': {
                ...
                descricaoCompleta: 'Nossa solução automatiza confirmações, lembretes, agendamentos e respostas frequentes, reduzindo a carga de trabalho da sua equipe em até 70%.',
                icone: 'whatsapp',
                caracteristicas: [
                    'Confirmação automática de consultas',
                    'Lembretes personalizados',
            ...
            'agendamento-inteligente': {
                ...
                descricaoCompleta: 'Elimina conflitos de horários, otimiza sua agenda e permite que pacientes agendem consultas online 24 horas por dia.',
                icone: 'calendar',
                caracteristicas: [
                    'Integração com Google Agenda',
                    'Agendamento online 24/7',
            ...
            'criacao-sites': {
                ...
                descricaoCompleta: 'Aumente sua presença digital, credibilidade e atraia mais pacientes com um site profissional desenvolvido especificamente para o setor de saúde.',
                icone: 'website',
                caracteristicas: [
                    'Design responsivo e moderno',
                    'Otimização para SEO',
